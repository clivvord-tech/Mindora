  ...
  return (
    <div className="w-full max-w-md space-y-6 animate-fade-in">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-slate-500 text-sm">We're glad you're here. How are you feeling today?</p>
      </div>

      <Card className="border-slate-200 shadow-card">
        <CardHeader className="pb-4">
          <CardTitle className="text-lg text-slate-900">Sign in to Mindora</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-slate-800 text-white hover:bg-slate-700 hover:scale-[0.97]" disabled={loading}>
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs text-slate-400 bg-card px-2">or continue with</div>
          </div>

          <Button variant="outline" className="w-full border-slate-200 text-slate-600 hover:bg-slate-50 hover:scale-[0.97] gap-2" disabled>
            <svg className="w-4 h-4" viewBox="0 0 24 24">
              <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/>
              <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/>
              <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#4285F4"/>
      ...
      <p className="text-center text-sm text-slate-500">
        ...
        <Link href="/signup" className="text-slate-800 hover:underline font-semibold">
          Sign up free
        </Link>
      </p>
    </div>
